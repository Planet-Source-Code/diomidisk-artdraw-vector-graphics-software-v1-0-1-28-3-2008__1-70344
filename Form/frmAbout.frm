...
Begin VB.Form frmAbout 
   ...
   Begin VB.Label lblDescription 
      Caption         =   "Draw application, with base the idea his Rod Stephens"
      ForeColor       =   &H00000000&
      Height          =   630
      Left            =   1170
      TabIndex        =   2
...
Private Sub Timer1_Timer()
     Dim txt As String
     txt = "ArtDraw " + vbCr + vbCr + lblVersion.Caption + vbCr + vbCr + " Special Thanks:" + vbCr + _
           "www.planet-source-code.com" + vbCr + "www.vbaccelerator.com" + vbCr + "vb-helper.com" + vbCr + _
           "edais.mvps.org" + vbCr + "www.codeguru.com" + vbCr + "binaryworld.net" + vbCr + vbCr + vbCr + vbCr
     Timer1.Enabled = False
     Scrolling = True
     Scroll Picture1, txt
End Sub
