...
'For Ctr = bteListIndex - 1 To UBound(arsPicPath) - 1 'Räknar i matrisen (som har basen 1) från den markerade posten till den näst sista posten.
 '   arsPicPath(Ctr) = arsPicPath(Ctr + 1) 'Drar ihop informationen.
'Next Ctr
'Combo1.RemoveItem (bteListIndex)  'Basen i listan är noll.
'ReDim Preserve arsPicPath(UBound(arsPicPath) - 1) 'Krymper matrisen med en cell.
...
'picBigBox.Picture = LoadPicture("c:\Any path\image.jpg")
